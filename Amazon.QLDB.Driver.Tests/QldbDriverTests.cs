...
namespace Amazon.QLDB.Driver.Tests
{
    ...
    public class QldbDriverTests
    {
        ...
        public void Execute_ISEOrTAOEOnExecute_ShouldRetryAndSucceedEventually(Exception exception)
        {
        ...
        public static IEnumerable<object[]> CreateDriverExceptions()
        {
            return new List<object[]>() {
                ...
                new object[] { new TransactionAlreadyOpenException(new Exception()) }
            };
        }
    }
}
